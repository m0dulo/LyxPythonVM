...
CodeObject::CodeObject(int argcount, int nlocals, int stacksize, int flag,
                       LyxString *bytecodes, ArrayList<LyxObject *> *consts,
                       ArrayList<LyxObject *> *names,
                       ArrayList<LyxObject *> *varnames,
                       ArrayList<LyxObject *> *freevars,
                       ArrayList<LyxObject *> *cellvars, LyxString *file_name,
                       LyxString *co_name, int lineno, LyxString *notable)
